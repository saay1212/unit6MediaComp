...
public class Picture extends SimplePicture 
{
  ...
  {
    Picture tom1 = new Picture("brady1.jpg");
    Picture tom = new Picture("brady.jpg");
    Picture tom3 = new Picture("brady1.jpg");
    Picture sb = new Picture("gronk.jpg");
    Picture sb1 = new Picture("gronk.jpg");
    Picture sb2 = new Picture("gronk.jpg");
    this.copy(sb,50,250);
    this.copy(sb1,220,370);
    this.copy(sb2,553,0);
    sb2.grayscale();
    sb1.grayscale();
    sb1.scaleByHalf(tom3);
    tom1.newedgeDetection(15);
    tom.grayscale();
    sb.grayscale();
    tom.scaleByHalf(tom1);
    this.copy(tom1,0,0);
    this.copy(sb,50,0);
    this.copy(tom1,150,0);
    Picture tom3NoBlue = new Picture(tom3);
    tom3NoBlue.zeroBlue();
    tom.mirrorDiagonalRightToLeft();
    this.copy(tom3NoBlue,40,0);
    this.copy(tom1,90,0);
    this.copy(tom,250,0);
    this.mirrorVertical();
  ...
  {
    Picture patriots = new Picture("pats.jpg");
    patriots.createCollage();
    patriots.explore();
  }
